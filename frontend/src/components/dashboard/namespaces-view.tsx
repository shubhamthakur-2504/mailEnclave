...
export default function NamespacesView({
  ...
  return (
    <div className="grid gap-4 md:grid-cols-[280px_1fr]">
      <aside className="rounded-2xl border border-border bg-card p-5 backdrop-blur-md transition-all duration-300 hover:border-primary/30">
      ...
      <article className="rounded-2xl border border-border bg-card p-6 backdrop-blur-md transition-all duration-300 hover:border-primary/30">
        ...
        <div className="mt-6 flex min-h-52 flex-col items-center justify-center rounded-xl border border-dashed border-primary/30 bg-primary/5 p-6 text-center">
          <Globe2 className="mb-3 size-7 text-primary" />
